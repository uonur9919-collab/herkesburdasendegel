...
<head>
    ...
    <style>
        ...
        .choice-item img {
            width: 100%; height: 130px; object-fit: cover; border-radius: 14px; margin-bottom: 10px;
        }
        .choice-item p {
            margin: 0; font-size: 13px; font-weight: 700; color: #fff;
        }
        .choice-item:hover {
            background: rgba(255,0,51,0.15); border-color: var(--primary-color);
        ...
        input:focus {
            ...
            background: rgba(255,255,255,0.2); box-shadow: 0 0 20px rgba(255,0,51,0.3);
        }
        .btn {
        ...
        .btn-red:hover {
            transform: translateY(-3px); box-shadow: 0 15px 30px rgba(255,0,51,0.6);
            background: #ff1a47;
        }
        .btn-outline {
        ...
        .char-img {
            width: 100%; border-radius: 20px; margin-bottom: 25px;
            box-shadow: 0 15px 35px rgba(0,0,0,0.5);
        }
        .step-label {
            color: var(--primary-color); font-weight: 800; font-size: 13px;
    ...
    <div class="main-container">
        ...
        <div id="step-choices" class="card">
            ...
            <div class="selection-grid">
                ...
                <div class="choice-item" onclick="move('age')"><img src="/files/5.jpg"><p>Büyük beden</p></div>
            </div>
        </div>
        ...
        <div id="step-final" class="card">
            ...
            <p style="font-weight: 700; color: #fff;">Merhaba bütün cevaplarınız için teşekkürler! Çılgınca fantezilerinizi gerçekleştirmek için son bir adım kaldı. Kayıt olun ve bu çılgın eğlencenin tadına bakın.</p>
